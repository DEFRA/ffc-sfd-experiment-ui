 ...
 */
export declare const remote: (params: RemoteOptions, remoteModifier?: (client: WebDriverTypes.Client, options: Options.WebdriverIO) => WebDriverTypes.Client) => Promise<WebdriverIO.Browser>;

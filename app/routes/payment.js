...
const { calculatePaymentAmount, submitFundingApplication, getLandParcels } = require('../services/experiment-api')
...
module.exports = [
  {
    ...
    handler: async (request, h) => {
      ...
      const actionPayments = await calculatePaymentAmount(selectedActions, landUseCodes)
